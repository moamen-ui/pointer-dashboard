...
The loader loads `https://api.pointer.moamen.work/pointer.js`, then appends a configured `<pointer-feedback>` element.
...
<script>
  var POINTER_SERVER = 'https://api.pointer.moamen.work';
