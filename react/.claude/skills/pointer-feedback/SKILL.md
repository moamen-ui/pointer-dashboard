...
shim served from `https://api.pointer.moamen.work/pointer.sh` and refreshed by `npx pointer-feedback update`. It reads
...
- This file was installed by fetching `https://api.pointer.moamen.work/skill.md` into
